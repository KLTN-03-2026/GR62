...
class DoiTacUpdateRequest extends FormRequest
{
    ...
    {
        return [
            'id.required' => 'Thiếu ID đối tác cần cập nhật',
            'id.integer'  => 'ID đối tác không hợp lệ',
            'id.exists'   => 'Đối tác không tồn tại',
