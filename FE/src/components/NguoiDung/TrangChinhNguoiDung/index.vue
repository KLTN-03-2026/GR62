                            ...
                            <div class="row mb-4">
                                <div class="col-md-6 d-flex flex-column justify-content-end">
                                    <h2 class="fw-bolder mb-2"
                                        style="color: #0f172a; letter-spacing: -0.5px; font-size: 2rem;">Chàos mừng trở
                                        lại,
                                        {{ ten_nguoi_dung }}
                                    </h2>
                                                ...
                                                <div class="d-none d-sm-flex align-items-center me-4">
                                                    <div class="avatar-group d-flex">
                                                        <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=100&q=80"
                                                            ...
                                                            width="32" height="32"
                                                            style="margin-left: -12px; z-index: 3;">
                                                        ...
                                                        <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=100&q=80"
                                                            class="rounded-circle border border-2 border-white ms-n2 shadow-sm"
                                                            width="32" height="32"
                                                            style="margin-left: -12px; z-index: 1;">
                        ...
                        <div v-if="currentTab === 'meetings'">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-lg-5">
                                    ...
                                    <!-- Meeting History -->
                                    <div>
                                        <h4 class="fw-bolder mb-4 text-dark" style="font-size: 1.25rem;">Lịch sử cuộc
                                            họp
                                        </h4>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content border-0 rounded-4 shadow-lg overflow-hidden">
                    <div class="modal-header bg-white border-0 px-4 py-3">
                        <div>
                            <h2 class="modal-title fw-bolder mb-1" id="NangCapGoiLabel"
                                style="font-size: 1.25rem; color: #0f172a;">Nâng cấp gói</h2>
                            <p class="small text-muted mb-0">Lựa chọn gói phù hợp để mở khóa trải nghiệm họp trực tuyến
                                nâng
                                cao.</p>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="card h-100 rounded-4 shadow-sm"
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        <div>
                                            <div class="badge rounded-pill px-3 py-2 mb-3 fw-bold text-white"
                                                style="background-color: #ea580c;">Gói Pro</div>
                                            ...
                                            <p class="text-muted mt-2" style="font-size: 0.95rem; line-height: 1.6;">
                                                Trải nghiệm
                                                phòng họp mượt mà với các tính năng cá nhân cơ bản và hỗ trợ ghi chú.
                                            </p>
                                            <div class="d-flex align-items-baseline mb-4 gap-2">
                                                <span class="fs-2 fw-bolder"
                                                    style="color: #0f172a; line-height: 1;">9.999</span>
                                                <span class="text-muted mb-2"
                                                    style="font-size: 0.95rem; line-height: 1.1;">đ/tháng</span>
                                            </div>
                                            <ul class="list-unstyled text-muted small mb-4" style="line-height: 1.8;">
                                                <li><i class="bx bx-check-circle me-2 text-success"></i>Phòng họp không
                                                    giới hạn
                                                </li>
                                                <li><i class="bx bx-check-circle me-2 text-success"></i>Hỗ trợ ghi âm và
                                                    lưu trữ
                                                </li>
                                                <li><i class="bx bx-check-circle me-2 text-success"></i>Face ID cơ bản
                                                </li>
                                            </ul>
                                        </div>
                                        <button type="button" class="btn w-100 text-white fw-bold mt-auto"
                                            style="background-color: #ea580c; border-radius: 12px;">Chọn Gói
                                            Pro</button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="card h-100 rounded-4 shadow-sm"
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        <div>
                                            <div class="badge rounded-pill px-3 py-2 mb-3 fw-bold text-white"
                                                style="background-color: #0f172a;">Gói Enterprise</div>
                                            <h3 class="fw-bolder mt-2 text-nowrap" style="color: #0f172a;">Dành cho
                                                doanh nghiệp
                                            </h3>
                                            <p class="text-muted mt-2" style="font-size: 0.95rem; line-height: 1.6;">
                                                Quản lý đội
                                                ngũ, bảo mật nâng cao và trải nghiệm họp chuyên nghiệp cho doanh nghiệp.
                                            </p>
                                            ...
                                            <ul class="list-unstyled text-muted small mb-4" style="line-height: 1.8;">
                                                <li><i class="bx bx-check-circle me-2 text-success"></i>Phòng họp nhiều
                                                    thành
                                                    viên</li>
                                                <li><i class="bx bx-check-circle me-2 text-success"></i>Hỗ trợ ưu tiên &
                                                    báo cáo
                                                </li>
                                                <li><i class="bx bx-check-circle me-2 text-success"></i>Face ID + bảo
                                                    mật nâng
                                                    cao</li>
                                            </ul>
                                        </div>
                                        <button type="button" class="btn w-100 text-white fw-bold mt-auto"
                                            style="background-color: #0f172a; border-radius: 12px;">Chọn Gói
                                            Enterprise</button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-footer bg-white border-0 px-4 py-3 justify-content-between">
                        <button type="button" class="btn btn-outline-secondary fw-semibold" data-bs-dismiss="modal"
                            style="border-radius: 12px;">Đóng</button>
                        <button type="button" class="btn text-white fw-bold"
                            style="background-color: #ea580c; border-radius: 12px;">Liên hệ tư vấn</button>
                    </div>
                </div>
            </div>
        </div>
